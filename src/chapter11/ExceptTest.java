...
class ExceptTestPanel extends Box
{
	...
	/*
	 * adds a radio button with a given listener to the panel. Traps
	 * any exceptions in the actionPerformed method of the listener.
	...
	private void addRadioButton(String s, ActionListener listener)
	{
		JRadioButton button = new JRadioButton (s, false)
			{
			  //the button calls this method to fire an action event.
			  //we override it to trap exceptions 
